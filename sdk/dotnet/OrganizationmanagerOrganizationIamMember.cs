...
namespace Pulumi.Yandex
{
    ...
    /// 
    /// &gt; Roles controlled by `yandex.OrganizationmanagerOrganizationIamBinding` should not be assigned using `yandex.OrganizationmanagerOrganizationIamMember`.
    /// 
    /// &gt; When you delete `yandex.OrganizationmanagerOrganizationIamBinding` resource, the roles can be deleted from other users within the organization as well. Be careful!
    /// 
    /// ## Example Usage
    /// 
