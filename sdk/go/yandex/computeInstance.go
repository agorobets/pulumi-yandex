...
type ComputeInstance struct {
	...
	// A set of disks to attach to the instance. The structure is documented below. **Note**: The `allowStoppingForUpdate` property must be set to true in order to update this structure.
