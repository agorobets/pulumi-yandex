...
type IamServiceAccountKey struct {
	...
	// The algorithm used to generate the key. `RSA_2048` is the default algorithm. Valid values are listed in the [API reference](https://cloud.yandex.com/docs/iam/api-ref/Key).
	...
	// ID of the Lockbox secret version that contains the value of `privateKey`. This is only populated when `outputToLockbox` is supplied. This version will be destroyed when the IAM key is destroyed, or when `outputToLockbox` is removed.
