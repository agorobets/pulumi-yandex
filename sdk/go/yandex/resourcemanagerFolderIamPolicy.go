...
type ResourcemanagerFolderIamPolicy struct {
	...
	// The `getIamPolicy` data source that represents the IAM policy that will be applied to the folder. This policy overrides any existing policy applied to the folder.
